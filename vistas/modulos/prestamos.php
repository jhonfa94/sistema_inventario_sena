                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div class="btn-group">
                      ...
                      <button class="btn btn-danger btnModalPdf" data-toggle="modal" data-target="#modalPdfPrestamo" data-dismiss="modal" idprestamo="<?= $prestamo['id'] ?>" ">
...
<!-- ===================== 
  MODAL PDF
========================= -->
<div id="modalPdfPrestamo" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header" style="background:#3c8dbc; color:white">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        ...
        <h4 class="modal-title" id="titleModalInfoPrestamoPdf">Info Prestamo  </h4>
        <button type="button" class="btn btn-primary" id="btnDescargarPdfPrestamo" data-id="">
      ...
      <div class="modal-body">
        <div class="box-body">
          <div class="row">
            <div class="col-12">
              <iframe id="iframePrestamoPdf" title="Préstamo"  src="" style="width:100%; height:700px;">
              </iframe>              
            </div>
          </div>
        </div>
